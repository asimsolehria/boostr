				...
				<td align="center" valign="top" bgcolor="#f7f7f7">
					<table class="body" style="
						...
						<tbody>
							...
							<tr>
								<td align="center" bgcolor="#FFFFFF">
									<table class="container" align="center" border="0" cellspacing="0" cellpadding="0" width="600" bgcolor="#f3f3f3">
										<tbody>
											<tr>
							...
							<tr>
								<td align="center" bgcolor="#FFFFFF">
									<table class="container" align="center" border="0" cellspacing="0" cellpadding="0" width="600">
										<tbody>
											<tr>
												<td class="column" align="center" style="
                                                            border-radius: 15px;
                                                        ">
													&nbsp;
												</td>
																									...
																									<table class="container" align="center" border="0" cellspacing="0" cellpadding="0" width="600">
																										<tbody>
																																						...
																																						<tbody>
																																							<tr>
																																								<td style="
                                                                                                                                                                            ...
                                                                                                                                                                            display: block;
                                                                                                                                                                        " bgcolor="#fef9e6">
																																									&nbsp;Just started playing golf again recently and was impressed with how well and long I could hit the ball. when looking for a set of <strong>clubs</strong> for myself I came across <strong>patriot golf</strong> and figured I’d give them a try, and I am glad I did. These clubs are light and <strong>built great</strong>
																																								</td>
																																							</tr>
																																						</tbody>
																																					</table>
																																			...
																																			<tr>
																																				<td class="column">
																																					<table width="100%" border="0" cellspacing="0" cellpadding="0">
																																						<tbody>
																																							<tr>
																																								<td width="332" valign="middle" class="column" style="
                                                                                                                                                                            font-family: 'open-sans',
                                                                                                                                                                                sans-serif;
                                                                                                                                                                            font-size: 14px;
                                                                                                                                                                        ">
																											...
																											?>
																																								...
																																								<tr>
																																									<td width="332" valign="middle" class="column" style="
																																										...
																																										<table width="100%" border="0" cellspacing="0" cellpadding="0">
																																											<tbody>
																																												<tr>
																																													<td width="22%" class="img-hide">
																																														<img src="<?php echo $image_url; ?>" width="90" height="80" alt="" />
																																													</td>
																																													<td width="78%" style="
                                                                                                                                                                                            font-family: 'open-sans',
                                                                                                                                                                                                sans-serif;
																																									...
																																									<td width="221" align="center" style="
                                                                                                                                                                            padding-bottom: 5px;
                                                                                                                                                                        ">
																																										<table width="100%" border="0" cellspacing="0" cellpadding="0">
																																											<tbody>
																												...
																												<tr>
																													<td class="side-pad" align="center" style="
                                                                                                                            font-size: 10px;
                                                                                                                        ">
																														&nbsp;
																													</td>
																			...
																			<tr>
																				<td class="column">
																					<table width="100%" border="0" cellspacing="0" cellpadding="0">
																						<tbody>
																							<tr>
																								<td valign="middle" class="column" width="270" style="padding-top: 20px;">
																									<span style="
                                                                                                                font-family: 'open-sans',
                                                                                                                    sans-serif;
                                                                                                                font-size: 14px;
																								...
																								<?php if (!wc_ship_to_billing_address_only() && $order->needs_shipping_address() && $shipping) : ?>
																									<td width="270" class="column" style="padding-top: 20px;">
																										<span style="
                                                                                                                font-family: 'open-sans',
                                                                                                                    sans-serif;
                                                                                                                font-size: 14px;
										...
										<tbody>
											...
											<tr>
												<td style="
													...
													<br />
													Alvast de handleiding
													van je net gekochte
													product(en) doornemen?
													Bekijk onze online
													handleiding pagina. -->
												</td>
											</tr>
