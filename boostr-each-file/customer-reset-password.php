																																						...
																																						<tbody>
																																							<tr>
																																								<td style="
																																									...
																																									<p>
																																										<a style="text-decoration: underline;" class="link" href="<?php echo esc_url(add_query_arg(array('key' => $reset_key, 'id' => $user_id), wc_get_endpoint_url('lost-password', '', wc_get_page_permalink('myaccount')))); ?>"><?php // phpcs:ignore 
																																																																																											?>
																																											<strong><?php esc_html_e('Click here to reset your password', 'woocommerce'); ?></strong>
																																										</a>
																																									</p>
